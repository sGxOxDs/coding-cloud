...
public class UIservice : MonoBehaviour
{
    ...
    public void Timer()
    {
        playingUI.transform.GetChild(0).GetComponent<Text>().text = "" + (15f - Catchservice.op_port.timer);
        playingUI.transform.GetChild(1).GetComponent<Scrollbar>().size = (15f - Catchservice.op_port.timer) / 15f;
    }
    ...
    public void save(float score)
    {
        ...
        if (rank.Count == 0) rank.Add(score.ToString());
