...
void testCopyConstructor()
{
   ...
   for( unsigned int i = 0; i < 1; i++ )
   {
      ...
      for( unsigned int j = 0; j < length; j++ )
      {
         ...
         vector1.insert( vector1.begin(), j );
         vector2.insert( vector2.begin(), j );
      }
      ...
      {
          cout << "size: " << vector1.size() << " / " << vector2.size() << endl;
          cout << "capacity: " << vector1.capacity() << " / " << vector2.capacity() << endl;
      }
   }
...
void testInsert1()
{
   ...
   for( unsigned int i = 0; i < number; i++ )
   {
      ...
      value = 1 + rand() % 99;
      vector1.insert( vector1.end() + position, value );
      vector2.insert( vector2.end() + position, value );
