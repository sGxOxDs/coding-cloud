...
#include <deque>
#include "­ìÀÉ/Deque - 1083339 - Mid 2­×.h"
//#include "Deque - 1083339 - Mid 2.h"
...
void testDeque1( unsigned int size )
{
   ...
   for( unsigned int k = 0; k < 4; k++ )
   {
      ...
      cout << endl;
      cout << "\tsize: " << *(reinterpret_cast<unsigned int*>(&data1) + 4);
      cout << "\toff: " << *(reinterpret_cast<unsigned int*>(&data1) + 3);;
      cout << "\t\tmapsize: " << *(reinterpret_cast<unsigned int*>(&data1) + 2) << endl;
      cout << "D2: ";
      for (auto a = data2.begin(); a != data2.end(); a++)
      {
          cout << *a << " ";
      }
      cout << endl;
      cout << "\tsize: " << *(reinterpret_cast<unsigned int*>(&data2) + 3);
      cout << "\toff: " << *(reinterpret_cast<unsigned int*>(&data2) + 2);
      cout << "\t\tmapsize: " << *(reinterpret_cast<unsigned int*>(&data2) + 1) << endl;
      cout <<"=========="<< endl;*/
   }
