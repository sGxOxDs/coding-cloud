...
void testCopyConstructor()
{
   ...
   for( unsigned int i = 0; i < number; i++ )
   {
      ...
      {
          cout << vector1.size() << "/" << vector4.size() << endl;
          cout << vector1.capacity() << "/" << vector4.capacity() << endl;
          system("pause");
      }
   }
...
void testAssignment1()
{
   ...
   for( unsigned int i = 0; i < number; i++ )
   {
      ...
      {
          cout << vector1.size() << "/" << vector1.capacity() << endl;
          cout << vector2.size() << "/" << vector2.capacity() << endl;
          cout << vector3.size() << "/" << vector3.capacity() << endl;
          cout << vector4.size() << "/" << vector4.capacity() << endl;
          system("pause");
      }
   }
