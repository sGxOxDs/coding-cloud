...
int main() 
{
    ...
    ChineseYear cy3;
    // Test 4: Create a default Chinese Year
    ...
    // Test 5: Create a wrong Chinese Year
    ...
    // Test 6: Display cy1, cy2 and cy3
    cout << "cy1 = " << cy1 << ", cy2 = " << cy2 << ", cy3 = "<< cy3 << endl;
    // Test 7: Increment cy1 and display
    cy1 += 1;
    cout << "cy1 = " << cy1 << endl;
    // Test 8: Add 3 to cy2 and display
    cout << "cy2 + 3 = " << cy2  + 3 << endl;
    // Test 9: Add 5 to cy2 and display, different order
